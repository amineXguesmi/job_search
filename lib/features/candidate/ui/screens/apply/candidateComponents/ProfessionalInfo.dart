...
class ProfessionalInfo extends StatefulWidget {
  ...
  ProfessionalInfo({Key? key, required this.user, required this.formKeys}) : super(key: key);
...
class _ProfessionalInfoState extends State<ProfessionalInfo> {
  ...
  void initState() {
    ...
    widget.user.educationSet!.add(Education(degree: "", college: "", startDate: "", endDate: ""));
                ...
                child: Column(
                  children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      getDateField(
                        "Start Date",
                        widget.user.educationSet![index].startDate!.split("T")[0],
                        (value) {
                          setState(
                            () {
                              widget.user.educationSet![index].startDate = value;
                            },
                          );
                        },
                      ),
                      getDateField("End Date", widget.user.educationSet![index].endDate!.split("T")[0], (value) {
                        setState(
                          () {
                            widget.user.educationSet![index].endDate = value;
                          },
                        );
                      }, finalDate: widget.user.educationSet![index].startDate!),
                    ])
                  ],
                ),
              )),
                  ...
                  children: [
                    ...
                    getTextField(
                      ...
                      (value) {
                        setState(
                          () {
                            widget.user.workSet![index].company_location = value;
                          },
                        );
                      },
                    ),
                    ...
                    DropdownComponent(
                      ...
                      valueHolder: widget.user.workSet![index].work_type ?? "Part Time",
                      onChanged: (value) {
                        setState(
                          () {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        getDateField("End Date", widget.user.workSet![index].endDate!.split("T")[0], (value) {
                          setState(
                            () {
  ...
  void addWorkControl() {
    setState(() {
      widget.user.workSet!
          .add(Work(job_title: "", company: "", company_location: "", work_type: "", startDate: "", endDate: ""));
    });
  }
